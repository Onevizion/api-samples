...
"""
EpiLog = OVUtils.PasswordExample + """Configuration File:
...
PDError = (
	OVUtils.CheckPasswords(PasswordData,'SMTP',['Server','Port','UserName','Password','To']),
	",\n",
	OVUtils.CheckPasswords(PasswordData,'dev-mtrac.mobilitie.com',['UserName','Password'])
	)
if len(PDError) > 6:
	print PDError
	quit()
...
for row in ParamFile:
	...
	# Attach Document
	fields[FieldName] = {'file_name':FileName,'data':B64Data}
